...
def summary_statistics( filename, model_name, history, frame_time, snr_db, 
	...
	with open(filename, "w") as text_file:
		...
		text_file.write( "\n" )
		text_file.write( "\tNumber of Filters Per Hidden Layer: " + ' ms, '.join(map(str, list(np.array(num_filters_per_hidden_layer)*1000))) ) 
		text_file.write( "\n" )
		text_file.write( "\tFilter Size Per Hidden Layer: " + ','.join(map(str, filter_size_per_hidden_layer)) )
		text_file.write( "\n" )
		text_file.write( "\tFilter Size for Output Layer: " + str( filter_size_output_layer ) )
		text_file.write( "\n" )
		text_file.write( "\tFrame Time: " + str( frame_time*1000 ) + str( " ms" ) )
		text_file.write( "\n" )
