...
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + model_name + "_FilteredTest_SameModel-5dB_Test" + str(snr_db) + "dB_5min.wav", rate = fs, data = test_filtered)
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + model_name + "_FilteredTest_SameModel-5dB_Test" + str(snr_db) + "dB_1min.wav", rate = fs, data = test_filtered[0:(60*fs)])
