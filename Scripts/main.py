...
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + "TriciaG_5min.wav", rate = fs, data = audio_time_series_test.astype('int16'))
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + "TriciaGNoisy_5dB_5min.wav", rate = fs, data = audio_time_series_test_noisy.astype('int16'))

scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + "TriciaG_1min.wav", rate = fs, data = audio_time_series_test.astype('int16')[0:(60*fs)])
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + "TriciaGNoisy_5dB_1min.wav", rate = fs, data = audio_time_series_test_noisy.astype('int16')[0:(60*fs)])
...
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + model_name + "_TriciaGFiltered_5min.wav", rate = fs, data = test_filtered)
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + model_name + "_TriciaGFiltered_1min.wav", rate = fs, data = test_filtered[0:(60*fs)])
os.chdir(parent_cwd + "/Audio_Files/Test_Files")
call( ["./PESQ", "+16000", "TriciaG_1min.wav", model_name + "_TriciaGFiltered_1min.wav"] )
call( ["./PESQ", "+16000", "TriciaG_1min.wav", "TriciaGNoisy_5dB_1min.wav"] )
