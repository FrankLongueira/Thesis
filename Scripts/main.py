...
audio_time_series_train_noise = np.random.normal(0, 1, audio_time_series_train.size) 
...
audio_time_series_test_noise = np.random.normal(0, 1, audio_time_series_test.size) 
