...
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + model_name + "_FilteredValidation_5min_" + str(snr_db) + "dB.wav", rate = fs, data = test_filtered)
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + model_name + "_FilteredValidation_1min_" + str(snr_db) + "dB.wav", rate = fs, data = test_filtered[0:(60*fs)])

os.chdir(parent_cwd + "/Audio_Files/Test_Files")
call( ["./PESQ", "+16000", "CleanValidation_1min_" + str(snr_db) + "dB.wav", "NoisyValidation_1min_" + str(snr_db) + "dB.wav"] )
call( ["./PESQ", "+16000", "CleanValidation_1min_" + str(snr_db) + "dB.wav", model_name + "_FilteredValidation_1min_" + str(snr_db) + "dB.wav"] )
