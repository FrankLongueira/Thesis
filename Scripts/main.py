...
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + model_name + "_FilteredTest_Tricia_Trained-5dB_Test" + str(snr_db) + "dB_5min.wav", rate = fs, data = test_filtered)
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + model_name + "_FilteredTest_Tricia_Trained-5dB_Test" + str(snr_db) + "dB_1min.wav", rate = fs, data = test_filtered[0:(60*fs)])
...
call( ["./PESQ", "+16000", "CleanTest_Tricia_1min_" + str(snr_db) + "dB.wav", model_name + "_FilteredTest_Tricia_Trained-5dB_Test" + str(snr_db) + "dB_1min.wav"] )
"""
