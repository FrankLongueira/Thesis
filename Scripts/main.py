...
# Generate test set
audio_time_series_test, fs = ap.load_audio( audio_folder_path, audio_filename = "Chapter3_5min.wav")
...
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + "NoisyTest_5min_0dB.wav", rate = fs, data = audio_time_series_test_noisy.astype('int16'))

scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + "CleanTest_1min_0dB.wav", rate = fs, data = audio_time_series_test.astype('int16')[0:(60*fs)])
scipy.io.wavfile.write( filename = parent_cwd + "/Audio_Files/Test_Files/" + "NoisyTest_1min_0dB.wav", rate = fs, data = audio_time_series_test_noisy.astype('int16')[0:(60*fs)])
